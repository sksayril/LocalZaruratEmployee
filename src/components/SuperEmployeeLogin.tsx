...
const SuperEmployeeLogin: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = await login(email, password, 'super-employee');
    ...
    <div className="max-w-md mx-auto">
      <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Super Employee Login</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <p className="text-sm text-yellow-800">
              <strong>Note:</strong> Super Employee access requires administrative approval and additional verification.
            </p>
          </div>
        ...
        <div className="mt-6 text-center">
          ...
          >
            Regular employee access instead?
          </Link>
        </div>
      </div>
    </div>
...
export default SuperEmployeeLogin;